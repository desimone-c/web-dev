...
const NavigationSidebar = () => {
    ...
    return(
        <>
            ...
            <Link to="/tuiter" className={`list-group-item list-group-item-action ${active === 'home' ? 'active' : ''} p-1`}
                aria-current={active === 'home' ? 'true': 'false'}>
                <i className="fas fa-home"></i><span className="d-xl-inline d-none">Home</span>
            </Link>
                        <Link to="/tuiter/explore" className={`list-group-item list-group-item-action ${active === 'explore' ? 'active' : ''} p-1`}
